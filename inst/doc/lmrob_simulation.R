...
##                             ) +
##       ylab(quote("empirical level "~ list (H[0] : beta[1] == 0.2) )) +
##       facet_wrap(~ Psi)
##       )
...
##                             ,labels=lab(tmp$method.cov, tmp2$method.cov)
##                             ) +
##       ylab(quote("empirical level "~ list (H[0] : beta[1] == 0.4) )) +
##       facet_wrap(~ Psi)
##       )
...
##                             , labels=lab(tmp$method.cov, tmp2$method.cov)
##                             ) +
##       ylab(quote("empirical level "~ list (H[0] : beta[1] == 0.6) )) +
##       facet_wrap(~ Psi)
##       )
...
##                             , labels=lab(tmp$method.cov, tmp2$method.cov)
##                             ) +
##       ylab(quote("empirical level "~ list (H[0] : beta[1] == 0.8) )) +
##       facet_wrap(~ Psi)
##       )
...
##                             , labels=lab(tmp$method.cov, tmp2$method.cov)
##                             ) +
##       ylab(quote("empirical level "~ list (H[0] : beta[1] == 1) )) +
##       facet_wrap(~ Psi)
##       )
